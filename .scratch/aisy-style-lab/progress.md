...
| Финальное сравнение | 3 | ПРОЙДЕНО | ПРОЙДЕНО | ПРОЙДЕНО | владелец выбрал A |
| Кнопочная система A/B | 3 | ПРОЙДЕНО | ПРОЙДЕНО | ПРОЙДЕНО | утверждена вместе с A |

### Решение владельца · 2026-08-26

- Единственная основа: **A — Бумажный маршрут**.
- Заимствования из B/C не выбраны и не добавляются автоматически.
- Approval-этап закрыт; следующий этап должен переносить именно A в production отдельным планом реализации.
- Запись решения: `owner-decision.md`.
