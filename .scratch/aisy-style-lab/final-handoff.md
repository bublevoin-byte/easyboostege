...
**Статус:** владелец выбрал **A — Бумажный маршрут**. Approval-прототип закрыт; production UI не изменён.
...
- Отклонённые полные направления: **B — Тактильные виджеты**, **C — Сюжетный маршрут**.
- Отдельные механики B/C не переносятся автоматически и требуют отдельного явного решения.
- Полная запись: `owner-decision.md`.
