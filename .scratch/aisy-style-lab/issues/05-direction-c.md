# 05 — C: Сюжетный маршрут от Today до Progress

**What to build:** Сделать тот же контур как высокий иллюстрированный путь со стадиями и landmarks, вдохновлённый приложенным story-screen референсом и выражающий продвижение ученика через маршрут Aisy.
