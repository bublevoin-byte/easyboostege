...
- [ ] Return a range/confidence/assumptions and never a guaranteed score.
- [ ] Provide increase-time/adjust-target choices when the goal is unrealistic.
- [ ] Keep allocation totals at 100% and cap ordinary revision changes at 10 percentage points.
