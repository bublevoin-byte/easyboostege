...
| Premium-entitlements, исходная bounded-ошибка и структурированные результаты Voice Tutor | пока существует аккаунт; нормализованный ошибочный ответ входит в учебный журнал исходных попыток, но не копируется в Voice Tutor session; аудио, временные субтитры и полный transcript отсутствуют | удаляются вместе с аккаунтом |
