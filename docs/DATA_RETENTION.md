...
| Найденные rule cards | bounded нормализованное правило, skill/год, URL, retrieval time, content hashes, status и review audit; fetched страницы не сохраняются | creator/reviewer обезличиваются при удалении аккаунта; карточка и неперсональный audit остаются для целостности canonical/review истории |
