...
| Premium-entitlements и структурированные резервы Voice Tutor | пока существует аккаунт; входят в экспорт без аудио и полного transcript | удаляются вместе с аккаунтом |
