...
const dbApi = {
  ...
  getProgress, saveProgress, mergeProgress, applyGrammarMasteryEvent, applyGrammarMasteryEvents, recordModuleAttempt, recordModuleAttemptWithAdaptiveClaim, bindAdaptiveLearningServerAttempt, getModuleAttempt, getReadingCompletedAttempts, upsertWordProgress, getWordProgress, upsertErrorBank,
  ...
  createWritingAttempt, claimWritingEvaluation, getWritingEvaluationClaim, markWritingEvaluationAmbiguous, finishWritingAttempt, getWritingAttempt, createSpeakingAttempt, claimSpeakingEvaluation, finishSpeakingAttempt, getSpeakingAttempt,
  ...
  syncEgeMockSpeakingBridge, getEgeMockResult, getEgeMockHistory,
