...
const dbApi = {
  ...
  getAdaptiveLearningSessionCreateReplay, createAdaptiveLearningSession,
  getCurrentAdaptiveLearningSession, getAdaptiveLearningSessionReplacementReplay,
  replaceAdaptiveLearningSessionBlock, getAdaptiveLearningWeekUsage,
...
async function buildMonitoringSnapshot() {
  const [aiUsage, voiceTutorRecovery, system] = await Promise.all([
    ...
    }), collectSystemMetrics(__dirname),
  ]);
