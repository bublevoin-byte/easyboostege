...
| № | Что даёт | Статус |
|---|---|---|
| 01 | Цепочку вызова ИИ можно позвать не только из веб-сервера — раннер бьёт в код приложения | pending |
...
Прогон не начат: спека и тикеты составлены 31 июля 2026 года.
