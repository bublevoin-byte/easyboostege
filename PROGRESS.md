...
| 02 | Локальный релизный аудит с доказательствами по критериям §24 | ready-for-agent |
...
остаются открытыми в строгом профиле; критерий §24.1 ждёт тикета 02. CLI-тесты 4/4, полный набор —
