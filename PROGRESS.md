...
| 06 | Сборка Vite: минификация, чанки, хешированные имена файлов | needs-info — ждёт установки зависимости владельцем |
...
Прогон закончен: восемь тикетов из девяти закрыты, 06 остаётся открытым и не блокирует запуск —
требования раздела 19 выполнены без сборщика.
