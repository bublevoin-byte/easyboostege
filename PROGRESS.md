...
Прогон тикетов закончен: восемь исходных выполнены, с девятого по одиннадцатый добавлены сверх них.
...
причина отказа — таймаут и применённый бюджет — лежит в строке журнала. Следующий шаг за владельцем:
