...
test('adaptive composer opens with the saved preferred duration and accepts goal-editor focus', async () => {
  ...
  assert.doesNotMatch(screen, /Free-демо|бесплатное пробное|нужен Premium/iu);
  assert.match(screen, /От 15 до 120 минут, шаг 5 минут/u);
  assert.match(screen, /Обратитесь к оператору/u);
