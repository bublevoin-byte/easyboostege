...
const frontendScriptPaths = ['auth.js', 'sync.js', 'store.js', 'components.js', 'router.js', 'learning.js', 'modules/words.js', 'modules/grammar.js', 'app.js', 'privacy.js', 'tts.js', 'pwa.js'].map(
