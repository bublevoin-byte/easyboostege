...
function tab(id){const previous=cur();if(id!==previous&&previous!=='scr5'&&previous!=='scr6')HIST.push(previous);showScreen(id);if(id==='scr2')initWords();if(id==='scr8')setTask(curTask);ROUTE_HOOKS.forEach(function(hook){try{hook(id,previous)}catch(e){console.error('Route hook failed',e)}})}
