 ...
 *
 * Сюда входят пять eager-экранов — «Сегодня», «Слова», «Грамматика», «Прогресс» и «Профиль», — потому что main.js
 * импортирует их наравне с оболочкой. Небольшие ленивые Practice и ЕГЭ hubs также предзагружаются намеренно:
 * верхнеуровневая навигация и честное описание offline-границ должны открываться без первого online-визита.
 * Остальные ленивые чанки, включая exact-пробник, и content shards отсутствуют: страница не должна просить их
 * при первой загрузке. В кэш они попадают ниже, в
