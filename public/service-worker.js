 ...
 */
/* build:app-shell */
const APP_SHELL=['/','/offline.html','/privacy.html','/task-bank.json','/audio/listening/listening-pilot-v1/manifest.json','/main.js','/globals.js','/api.js','/auth.js','/access.js','/owner-incarnation.js','/sync.js','/store.js','/components.js','/router.js','/learning.js','/vocabulary-domain.js','/vocabulary-session-view.js','/adaptive-activity-contract.js','/adaptive-activity-launch.js','/adaptive-overview-cache.js','/adaptive-session-runtime.js','/learning-activity-contract.js','/learning-activity-recorder.js','/grammar-domain-contract.js','/grammar-tenses-content.js','/grammar-verb-constructions-content.js','/grammar-parts-of-speech-content.js','/grammar-catalog-content.js','/grammar-catalog.js','/reading-catalog-contract.js','/reading-pilot-v1.js','/speaking-assessment-contract.js','/modules/words.js','/modules/grammar.js','/modules/reading.js','/modules/listening.js','/modules/writing.js','/modules/speaking.js','/modules/exam.js','/modules/progress.js','/modules/profile.js','/modules/core-voice-catalog.js','/app.js','/voice-tutor.js','/realtime-transport.js','/screens.js','/screens/words.js','/screens/grammar.js','/screens/progress.js','/screens/profile.js','/privacy.js','/listening-audio-contract.js','/tts.js','/pwa.js','/manifest.json','/pwa-icon.svg','/icon-192.png','/icon-512.png','/icon-maskable-512.png'];
/* end build:app-shell */
/*
